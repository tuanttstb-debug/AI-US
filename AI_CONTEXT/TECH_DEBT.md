...
> **Delta phiên 2026-08-22 #2:** Không nợ mới (phiên thuần tài liệu/skill). Đóng **một phần** [OPEN] của **TD-KB-01**: `REF-TPBANK-DELIVERY §1b` đã điền **owner-unit IT** thật (PM.IT·Dev1/3=BPM·Dev2=CRM·CBS=FCC·ITA.IT·CA.CB·DP/Data·CCP) từ dự án PFMP — vẫn cấp đơn vị (chưa có PER-* cá nhân). Skill `email-writer` thuần tài liệu (không nợ runtime).
